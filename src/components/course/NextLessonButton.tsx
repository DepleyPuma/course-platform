  ...
  return (
    <form action={formAction}>
      ...
      <Button
        type="submit"
        disabled={isPending}
        className="flex w-full cursor-pointer items-center gap-2 bg-brand px-6 py-6 text-black hover:bg-brand-hover disabled:cursor-not-allowed disabled:opacity-50"
      >
        <span>
          {isPending
            ? "Zapisywanie..."
